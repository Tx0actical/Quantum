...
{
    [SourceLocation("C:\\Users\\ADMIN\\Documents\\Amit\\Quantum\\QuantumRNG\\Program.qs", OperationFunctor.Body, 8, 15)]
...
#line hidden
            {
#line 10 "C:\\Users\\ADMIN\\Documents\\Amit\\Quantum\\QuantumRNG\\Program.qs"
                var q = Allocate__.Apply();
#line hidden
                bool __arg1__ = true;
                try
                {
#line 11 "C:\\Users\\ADMIN\\Documents\\Amit\\Quantum\\QuantumRNG\\Program.qs"
                    Microsoft__Quantum__Intrinsic__H.Apply(q);
#line 12 "C:\\Users\\ADMIN\\Documents\\Amit\\Quantum\\QuantumRNG\\Program.qs"
...
#line hidden
    ...
    [SourceLocation("C:\\Users\\ADMIN\\Documents\\Amit\\Quantum\\QuantumRNG\\Program.qs", OperationFunctor.Body, 15, 28)]
    public partial class SampleRandomNumberInRange : Operation<Int64, Int64>, ICallable
    {
        ...
        {
            var max = __in__;
#line 16 "C:\\Users\\ADMIN\\Documents\\Amit\\Quantum\\QuantumRNG\\Program.qs"
            var output = 0L;
#line 17 "C:\\Users\\ADMIN\\Documents\\Amit\\Quantum\\QuantumRNG\\Program.qs"
            while (true)
            {
#line 18 "C:\\Users\\ADMIN\\Documents\\Amit\\Quantum\\QuantumRNG\\Program.qs"
                var bits = new QArray<Result>();
#line 19 "C:\\Users\\ADMIN\\Documents\\Amit\\Quantum\\QuantumRNG\\Program.qs"
                foreach (var idxBit in new QRange(1L, Microsoft__Quantum__Math__BitSizeI.Apply(max)))
#line hidden
                {
#line 20 "C:\\Users\\ADMIN\\Documents\\Amit\\Quantum\\QuantumRNG\\Program.qs"
                    bits = QArray<Result>.Add(bits, new QArray<Result>(GenerateRandomBit__.Apply(QVoid.Instance)));
                }

#line 22 "C:\\Users\\ADMIN\\Documents\\Amit\\Quantum\\QuantumRNG\\Program.qs"
...
#line 24 "C:\\Users\\ADMIN\\Documents\\Amit\\Quantum\\QuantumRNG\\Program.qs"
            return output;
        }
    ...
    [SourceLocation("C:\\Users\\ADMIN\\Documents\\Amit\\Quantum\\QuantumRNG\\Program.qs", OperationFunctor.Body, 28, -1)]
